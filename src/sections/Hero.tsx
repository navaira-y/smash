...
export default function Hero() {
  ...
  return (
    <section id="top" ref={ref} className="relative h-[100svh] min-h-[560px] overflow-hidden bg-black">      <img
      ...
      <div className="absolute inset-0 bg-gradient-to-r from-black/70 via-transparent to-black/40" />      <div className="hero-hud absolute inset-0 opacity-0 pointer-events-none">
        <div className="hud-corners absolute inset-3 md:inset-6">
          <span className="hc" />
        </div>        <div className="absolute top-6 left-6 md:top-8 md:left-10 flex items-center gap-2 font-mono text-[9px] tracking-[0.25em] text-ink/70">
        ...
        <div className="absolute top-6 right-6 md:top-8 md:right-10 font-mono text-[9px] tracking-[0.25em] text-ink/70">
          60 FPS · F2.0 · ISO 400
        </div>        <div className="absolute left-6 md:left-10 top-1/2 -translate-y-1/2 hidden md:flex flex-col items-start gap-10">
        ...
        </div>        <div className="absolute left-0 right-0 bottom-0">
      ...
      </div>      <div className="hero-copy absolute left-6 md:left-16 bottom-24 md:bottom-28 z-10">
